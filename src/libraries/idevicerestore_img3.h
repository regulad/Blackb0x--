 ...
 */
//
// Copied from libimobiledevice/idevicerestore @ src/img3.h (current HEAD
// as of 2026-09), unchanged except the rename (img3.h -> idevicerestore_img3.h,
// avoiding a collision with third_party/xpwn's own unrelated img3.h) and
// the include guard to match. See idevicerestore_img3.c's own header
// comment for why this one file is vendored directly instead of the
// whole idevicerestore tree.
//
